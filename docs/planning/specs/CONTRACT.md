...
export interface CreateSessionDto {
  ...
  targetLanguages: LanguageCodeValue[];
  source: AudioSourceSpec;
  glossary?: { source: string; translations: Partial<Record<LanguageCodeValue, string>> }[];
}
...
export const captionRoom = (sessionId: string, lang: LanguageCodeValue) =>
